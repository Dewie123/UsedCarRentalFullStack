...
def shortlist_listing(user_id,listing_id):
    models.save_listing_for_user(user_id,listing_id)
...
def create_listing(form_data, image_files,user_id , dealer_name):
    ...
    models.insert_car_listing(listing_type, seller_name ,car_name, price, depreciation, mileage, road_tax, dereg_value, coe, 
